    ...
    >
      <nav className="container mx-auto px-6 flex items-center justify-between">
        ...
        >
          ...
          <img
            src={logo} 
            alt="J&L Kabini Palace Logo"
            className={`h-20 w-auto ${
              isScrolled ? "drop-shadow-sm" : "drop-shadow-md"
            }   filter brightness-0 invert sepia saturate-[500%] hue-rotate-[330deg]`}
          />
        ...
        <div className="hidden md:flex items-center space-x-8">
          {navItems.map((item, index) => (
            <motion.a
              ...
              transition={{
                delay: isVisible ? 0.5 + index * 0.1 : 0,
                duration: 0.5,
              }}
